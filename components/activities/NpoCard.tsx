...
export default function NpoCard() {
  return (
    ...
    >
      ...
      <span className="mt-auto inline-flex items-center gap-3 font-jetbrains text-[11px] tracking-[0.2em] uppercase text-fog group-hover:text-electric-soft transition-colors">
        Visit site
